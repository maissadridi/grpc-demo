...
public class HelloWorldClient {
    ...
    /**
     * Greet server. If provided, the first element of {@code args} is the first
     * name, the second element is the last name, and the third element is the CIN
     * (Client Identification Number).
     */
    public static void main(String[] args) throws Exception {
        String firstName = "Maissa";
        String lastName = "Dridi";
        String cin = "58585858"; // Example CIN
        ...
        if (args.length > 0) {
            if ("--help".equals(args[0])) {
                ...
                System.err.println("");
                System.err.println("  firstName   The first name of the person you wish to be greeted by. Defaults to "
                        + firstName);
                System.err.println(
                        "  lastName    The last name of the person you wish to be greeted by. Defaults to " + lastName);
